...
```
请为我搭建一个以 {argument name="theme_en" default="Thanksgiving Charlie Brown"} 为主题和风格的商店。
```
...
### No. 3: 奢华 3D 腕表产品体验页面 (Next.js + Three.js)
...
滚动体验（5 个部分）：
英雄部分 – 腕表从黑暗中缓缓出现，旋转着进入光线中。实现全息效果和菲涅尔反射，并使用自定义着色器。
细节放大 – 表盘特写。使用 GLSL 实现金属反射、视差映射和实时光泽度。
机械拆解 – 腕表拆解，内部机芯在空中漂浮。使用置换着色器实现能量场效果，并为每个部件添加发光效果。
材质体验 – 在不同材质变体之间切换。通过 PBR 着色器以物理方式表达金属感、玻璃折射和钛金属的哑光纹理。
...
一个幽默的中文提示，角色扮演一位资深游戏编程大师，描述了如何使用 WebCodecs 构建编辑器并捕捉《塞尔达传说：旷野之息》的游戏画面。

#### 📝 提示词

```
你是一位经验丰富的游戏编程大师。请帮我编写一个编辑器，其渲染模块使用 WebCodecs。打开 Switch 并插入 {argument name="game_title_en" default="The Legend of Zelda: Breath of the Wild"}。小心不要舔卡带——它有点苦。使用专业的采集卡捕捉视频，在 60 秒的时间限制内完成“被遗忘的圣殿”挑战并使用风弹。
```
...
一个详细的多步骤提示序列，用于指导 Gemini 3 Pro 使用 Three.js、Anime.js 和 Tailwind 构建一个奢华智能手表着陆页，然后将其完善为一个具有高级动画和交互的多区段滚动网站。

#### 📝 提示词

```
使用 Three.js、Anime.js 和 Tailwind 为一个 {argument name="product_type_en" default="豪华智能手表"} 页面创建一个 HTML 文件。制作一个 3D {argument name="main_object_en" default="手表"} 模型，一个带有圆形孔洞的深色纹理叠加层，显示 {argument name="main_object_background_en" default="米色背景上的手表"}，并在页面加载时让标题和大数字滑入。

让页面更专业。用一个加载时打开的光圈取代静态孔洞。在 {argument name="focus_area_en" default="表盘"} 上方添加一个带有反射的玻璃穹顶，改进金属材质，添加鼠标视差效果，使 {argument name="parallax_target_en" default="手表"} 随光标旋转，并在 {argument name="dial_area_en" default="表盘"} 上绘制时间和健身环。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209174368_jdx5gi_6A51eMDR7nvxQOPd.jpg" width="600" alt="带动画部分的奢华智能手表 Three.js 登录页面 - Image 1">
</div>
...
一个日语提示，要求 Gemini 生成 40 个浅蓝色线条风格的简单、多功能 SVG 图标，并为每个图标提供下载按钮。

#### 📝 提示词

```
生成 {argument name="icon_count_en" default="40"} 个简单且高度通用的 SVG 格式图标。请务必在画布上绘制它们。颜色应为 {argument name="icon_color_en" default="light blue"}。背景应为 {argument name="background_color_en" default="white"}。使用具有 Material Design 风格的线条图标。添加一个按钮，让用户可以将每个 SVG 图标下载为 SVG 数据。
```
...
### No. 8: 未来感十足的加密货币仪表盘 UI

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 描述

一个中文提示，用于重新创建具有玻璃拟态、霓虹灯点缀和时尚 Inter 字体的未来主义深色模式加密货币数据仪表板。

#### 📝 提示词

```
重新创建一个未来主义的深色模式加密货币数据仪表板：整体采用高对比度的黑曜石背景，玻璃拟态 UI 元素配以渐变轮廓，纤细的 Inter 字体，以及带有霓虹灯效果的金融数据可视化。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209220218_kppymm_mu18egPuhdhyynBc.jpg" width="600" alt="未来感十足的加密货币仪表盘 UI - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E9%87%8D%E6%96%B0%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E6%9C%AA%E6%9D%A5%E4%B8%BB%E4%B9%89%E7%9A%84%E6%B7%B1%E8%89%B2%E6%A8%A1%E5%BC%8F%E5%8A%A0%E5%AF%86%E8%B4%A7%E5%B8%81%E6%95%B0%E6%8D%AE%E4%BB%AA%E8%A1%A8%E6%9D%BF%EF%BC%9A%E6%95%B4%E4%BD%93%E9%87%87%E7%94%A8%E9%AB%98%E5%AF%B9%E6%AF%94%E5%BA%A6%E7%9A%84%E9%BB%91%E6%9B%9C%E7%9F%B3%E8%83%8C%E6%99%AF%EF%BC%8C%E7%8E%BB%E7%92%83%E6%8B%9F%E6%80%81%20UI%20%E5%85%83%E7%B4%A0%E9%85%8D%E4%BB%A5%E6%B8%90%E5%8F%98%E8%BD%AE%E5%BB%93%EF%BC%8C%E7%BA%A4%E7%BB%86%E7%9A%84%20Inter%20%E5%AD%97%E4%BD%93%EF%BC%8C%E4%BB%A5%E5%8F%8A%E5%B8%A6%E6%9C%89%E9%9C%93%E8%99%B9%E7%81%AF%E6%95%88%E6%9E%9C%E7%9A%84%E9%87%91%E8%9E%8D%E6%95%B0%E6%8D%AE%E5%8F%AF%E8%A7%86%E5%8C%96%E3%80%82)**

---

### No. 9: HTML 中的 SVG 摩天轮机械动画
...
```
设计一个 SVG 摩天轮机械动画，包括主轮、中心轴承、支撑架、驱动齿轮组以及 8 到 12 个带有反向自调平机制的座舱，以保持座舱水平。所有连杆和齿轮传动必须精确，展示完整的机械传动链以及保持座舱水平的反向旋转逻辑。输出为 HTML 格式。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E8%AE%BE%E8%AE%A1%E4%B8%80%E4%B8%AA%20SVG%20%E6%91%A9%E5%A4%A9%E8%BD%AE%E6%9C%BA%E6%A2%B0%E5%8A%A8%E7%94%BB%EF%BC%8C%E5%8C%85%E6%8B%AC%E4%B8%BB%E8%BD%AE%E3%80%81%E4%B8%AD%E5%BF%83%E8%BD%B4%E6%89%BF%E3%80%81%E6%94%AF%E6%92%91%E6%9E%B6%E3%80%81%E9%A9%B1%E5%8A%A8%E9%BD%BF%E8%BD%AE%E7%BB%84%E4%BB%A5%E5%8F%8A%208%20%E5%88%B0%2012%20%E4%B8%AA%E5%B8%A6%E6%9C%89%E5%8F%8D%E5%90%91%E8%87%AA%E8%B0%83%E5%B9%B3%E6%9C%BA%E5%88%B6%E7%9A%84%E5%BA%A7%E8%88%B1%EF%BC%8C%E4%BB%A5%E4%BF%9D%E6%8C%81%E5%BA%A7%E8%88%B1%E6%B0%B4%E5%B9%B3%E3%80%82%E6%89%80%E6%9C%89%E8%BF%9E%E6%9D%86%E5%92%8C%E9%BD%BF%E8%BD%AE%E4%BC%A0%E5%8A%A8%E5%BF%85%E9%A1%BB%E7%B2%BE%E7%A1%AE%EF%BC%8C%E5%B1%95%E7%A4%BA%E5%AE%8C%E6%95%B4%E7%9A%84%E6%9C%BA%E6%A2%B0%E4%BC%A0%E5%8A%A8%E9%93%BE%E4%BB%A5%E5%8F%8A%E4%BF%9D%E6%8C%81%E5%BA%A7%E8%88%B1%E6%B0%B4%E5%B9%B3%E7%9A%84%E5%8F%8D%E5%90%91%E6%97%8B%E8%BD%AC%E9%80%BB%E8%BE%91%E3%80%82%E8%BE%93%E5%87%BA%E4%B8%BA%20HTML%20%E6%A0%BC%E5%BC%8F%E3%80%82)**

---

### No. 10: Keep-inspired 中文健身课程网站

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 描述

请为我创建一个中文健身课程网站，灵感来源于 Keep。该网站应具备响应式设计，并使用 Tailwind CSS 构建。网站上应有课程卡片，用户可以根据不同的标准进行筛选。点击课程卡片后，应弹出一个视频播放器，播放与该课程匹配的视频。

#### 📝 提示词

```
构建一个受 Keep 启发的中文“健身课程”网页：包含全屏运动员英雄图片、透明的固定导航栏、中文胶囊标签分类，以及中文课程卡片网格。每张课程卡片对应一个训练计划；参考 Pamela、周六野、韩小四、Jojie、刘畊宏等创作者的课程风格，设计中文标题以及难度和时长标签。点击卡片时，在页面内打开一个课程预览视频播放器，其内容须与卡片信息严格匹配。整体设计力求简约而不失细节，通过流畅的滚动和悬停动画、柔和的渐变以及精致的排版，营造高端的中文体验。使用 Tailwind CSS 实现完全响应式布局。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209207369_aa3rub_Com2rFXK131nN-WJ.jpg" width="600" alt="Neo-Brutalist website design prompt - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=Create%20a%20neo-Brutalist%20website%20that%20pushes%20the%20boundaries%20of%20creativity.%20Include%20smooth%20scrolling%20animations%2C%20vibrant%20colors%2C%20and%20Tailwind%20ES%20styles%2C%20and%20make%20it%20fully%20responsive.)**

---

### No. 13: 复古宝丽来相机网站，带照片墙
...
### No. 14: 塔罗牌风格的解梦日志网络应用

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 描述

一个用于构建中文网络应用的提示，用户每天早上可以在其中记录梦境、拼贴贴纸插图，最后生成一张塔罗牌般的梦境卡片。

#### 📝 提示词

```
生成一个中文网页应用，用户每天早上可以在其中记录自己的梦境。该应用提供大量“插画贴纸”供用户拼贴和重构梦境场景，最终生成一张看起来像塔罗牌的梦境卡片。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209238976_et7ieq_7pJ4fC5sdbhGHT7S.jpg" width="600" alt="塔罗牌风格的解梦日志网络应用 - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E7%94%9F%E6%88%90%E4%B8%80%E4%B8%AA%E4%B8%AD%E6%96%87%E7%BD%91%E9%A1%B5%E5%BA%94%E7%94%A8%EF%BC%8C%E7%94%A8%E6%88%B7%E6%AF%8F%E5%A4%A9%E6%97%A9%E4%B8%8A%E5%8F%AF%E4%BB%A5%E5%9C%A8%E5%85%B6%E4%B8%AD%E8%AE%B0%E5%BD%95%E8%87%AA%E5%B7%B1%E7%9A%84%E6%A2%A6%E5%A2%83%E3%80%82%E8%AF%A5%E5%BA%94%E7%94%A8%E6%8F%90%E4%BE%9B%E5%A4%A7%E9%87%8F%E2%80%9C%E6%8F%92%E7%94%BB%E8%B4%B4%E7%BA%B8%E2%80%9D%E4%BE%9B%E7%94%A8%E6%88%B7%E6%8B%BC%E8%B4%B4%E5%92%8C%E9%87%8D%E6%9E%84%E6%A2%A6%E5%A2%83%E5%9C%BA%E6%99%AF%EF%BC%8C%E6%9C%80%E7%BB%88%E7%94%9F%E6%88%90%E4%B8%80%E5%BC%A0%E7%9C%8B%E8%B5%B7%E6%9D%A5%E5%83%8F%E5%A1%94%E7%BD%97%E7%89%8C%E7%9A%84%E6%A2%A6%E5%A2%83%E5%8D%A1%E7%89%87%E3%80%82)**

---

### No. 15: 使用 Gemini 和 React 的 3D 积木搭建应用
...
```
请扮演一位世界级的全栈工程师和用户体验设计师。使用 React、Three.js (@react-three/fiber)、Tailwind CSS 和 Google Gemini API (@google/genai) 构建一个 {argument name="application_name_en" default="3D 砖块构建器应用程序"}。

## 设计理念
- **主题**：{argument name="theme_en" default="White Base"} 现代美学。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209267012_gx9du5_eHxLjy9ur6Zi0Prr.jpg" width="600" alt="使用 Gemini 和 React 的 3D 积木搭建应用 - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E8%AF%B7%E6%89%AE%E6%BC%94%E4%B8%80%E4%BD%8D%E4%B8%96%E7%95%8C%E7%BA%A7%E7%9A%84%E5%85%A8%E6%A0%88%E5%B7%A5%E7%A8%8B%E5%B8%88%E5%92%8C%E7%94%A8%E6%88%B7%E4%BD%93%E9%AA%8C%E8%AE%BE%E8%AE%A1%E5%B8%88%E3%80%82%E4%BD%BF%E7%94%A8%20React%E3%80%81Three.js%20(%40react-three%2Ffiber)%E3%80%81Tailwind%20CSS%20%E5%92%8C%20Google%20Gemini%20API%20(%40google%2Fgenai)%20%E6%9E%84%E5%BB%BA%E4%B8%80%E4%B8%AA%20%7Bargument%20name%3D%22application_name_en%22%20default%3D%223D%20%E7%A0%96%E5%9D%97%E6%9E%84%E5%BB%BA%E5%99%A8%E5%BA%94%E7%94%A8%E7%A8%8B%E5%BA%8F%22%7D%E3%80%82%0A%0A%23%23%20%E8%AE%BE%E8%AE%A1%E7%90%86%E5%BF%B5%0A-%20**%E4%B8%BB%E9%A2%98**%EF%BC%9A%7Bargument%20name%3D%22theme_en%22%20default%3D%22White%20Base%22%7D%20%E7%8E%B0%E4%BB%A3%E7%BE%8E%E5%AD%A6%E3%80%82)**

---

### No. 16: X (Twitter) MBTI 分析器网页应用
...
### No. 17: 中国 AI 汉服衣橱网络应用

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 描述

一个用于生成中文网页应用的提示，该应用允许用户上传照片并虚拟试穿不同朝代的汉服，包括自定义发簪和妆容，可能是一个单页 HTML 应用。

#### 📝 提示词

```
开发一款 AI 汉服衣橱应用，该应用使用 AI 换脸或 3D 体型技术。用户可以上传照片，一键“试穿”来自不同朝代（如唐、宋、明）的汉服，或者自由搭配发簪和妆容。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209249948_o2ejtv_bEBJ9Q-sEm-FuO9_.jpg" width="600" alt="中国 AI 汉服衣橱网络应用 - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E5%BC%80%E5%8F%91%E4%B8%80%E6%AC%BE%20AI%20%E6%B1%89%E6%9C%8D%E8%A1%A3%E6%A9%B1%E5%BA%94%E7%94%A8%EF%BC%8C%E8%AF%A5%E5%BA%94%E7%94%A8%E4%BD%BF%E7%94%A8%20AI%20%E6%8D%A2%E8%84%B8%E6%88%96%203D%20%E4%BD%93%E5%9E%8B%E6%8A%80%E6%9C%AF%E3%80%82%E7%94%A8%E6%88%B7%E5%8F%AF%E4%BB%A5%E4%B8%8A%E4%BC%A0%E7%85%A7%E7%89%87%EF%BC%8C%E4%B8%80%E9%94%AE%E2%80%9C%E8%AF%95%E7%A9%BF%E2%80%9D%E6%9D%A5%E8%87%AA%E4%B8%8D%E5%90%8C%E6%9C%9D%E4%BB%A3%EF%BC%88%E5%A6%82%E5%94%90%E3%80%81%E5%AE%8B%E3%80%81%E6%98%8E%EF%BC%89%E7%9A%84%E6%B1%89%E6%9C%8D%EF%BC%8C%E6%88%96%E8%80%85%E8%87%AA%E7%94%B1%E6%90%AD%E9%85%8D%E5%8F%91%E7%B0%AA%E5%92%8C%E5%A6%86%E5%AE%B9%E3%80%82)**

---

### No. 18: 复古摩托罗拉寻呼机打字机网页应用
...
一个用于 Gemini 3 Pro 的中文提示，旨在构建一个复古风格的摩托罗拉传呼机打字网页应用。在该应用中，一个中央打字机将用户输入转换为缓慢打出的卡片，这些卡片可以在页面上随意拖动。

#### 📝 提示词

```
请帮我创建一个以 {argument name="device_name_en" default="Motorola Fix Beeper"} 为主题的复古打字机应用程序。网页中央显示一台打字机，可以将用户输入的文本转换成卡片，效果类似于打字机缓慢地打出文字，并且卡片可以拖动到页面的空白区域。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E8%AF%B7%E5%B8%AE%E6%88%91%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E4%BB%A5%20%7Bargument%20name%3D%22device_name_en%22%20default%3D%22Motorola%20Fix%20Beeper%22%7D%20%E4%B8%BA%E4%B8%BB%E9%A2%98%E7%9A%84%E5%A4%8D%E5%8F%A4%E6%89%93%E5%AD%97%E6%9C%BA%E5%BA%94%E7%94%A8%E7%A8%8B%E5%BA%8F%E3%80%82%E7%BD%91%E9%A1%B5%E4%B8%AD%E5%A4%AE%E6%98%BE%E7%A4%BA%E4%B8%80%E5%8F%B0%E6%89%93%E5%AD%97%E6%9C%BA%EF%BC%8C%E5%8F%AF%E4%BB%A5%E5%B0%86%E7%94%A8%E6%88%B7%E8%BE%93%E5%85%A5%E7%9A%84%E6%96%87%E6%9C%AC%E8%BD%AC%E6%8D%A2%E6%88%90%E5%8D%A1%E7%89%87%EF%BC%8C%E6%95%88%E6%9E%9C%E7%B1%BB%E4%BC%BC%E4%BA%8E%E6%89%93%E5%AD%97%E6%9C%BA%E7%BC%93%E6%85%A2%E5%9C%B0%E6%89%93%E5%87%BA%E6%96%87%E5%AD%97%EF%BC%8C%E5%B9%B6%E4%B8%94%E5%8D%A1%E7%89%87%E5%8F%AF%E4%BB%A5%E6%8B%96%E5%8A%A8%E5%88%B0%E9%A1%B5%E9%9D%A2%E7%9A%84%E7%A9%BA%E7%99%BD%E5%8C%BA%E5%9F%9F%E3%80%82)**
...
一个给 Gemini 3 Pro 的提示，用于构建一个单页中文网络应用，将每个星星或星座以绘本形式呈现，结合星座连线和插画神话人物。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209237338_qmtoz8_2y43kqiU39gDRcwd.jpg" width="600" alt="赛博朋克风现代中国万年历网页应用 - Image 1">
</div>
...
一个中文提示，用于构建一个复古宝丽来相机网页应用。该应用中，左下角的相机连接到网络摄像头，弹出正在显影的照片，并允许用户拖动这些照片以形成照片墙。

#### 📝 提示词

```
请帮我创建一个复古宝丽来风格的相机网页应用。在页面左下角，显示一个可以连接网络摄像头并显示实时预览的相机。当点击快门按钮时，一张相纸会从相机顶部缓慢弹出，照片会从模糊逐渐变得清晰。用户可以将显影后的照片从相机上方拖动到相机以外的页面区域，从而创建出照片墙般的效果。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209159016_6yk3yw_TCUAUpzJbxn8xmOV.jpg" width="600" alt="在 Three.js 中使用光线步进算法渲染的 Mandelbulb 分形，带有音频响应粒子 - Image 1">
</div>
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209176859_vznbt0_UPKTu2bYW7AZTCBs.jpg" width="600" alt="AP 的代理风格网站 - Image 1">
</div>
...
```
生成一个网页应用，每天介绍一种{argument name="color_system_en" default="传统中国色"}（例如：{argument name="example_color_1_en" default="天青"}、{argument name="example_color_2_en" default="胭脂"}、{argument name="example_color_3_en" default="黛螺"}），并配以相关的古典诗词、器物插画或自然风光。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E7%94%9F%E6%88%90%E4%B8%80%E4%B8%AA%E7%BD%91%E9%A1%B5%E5%BA%94%E7%94%A8%EF%BC%8C%E6%AF%8F%E5%A4%A9%E4%BB%8B%E7%BB%8D%E4%B8%80%E7%A7%8D%7Bargument%20name%3D%22color_system_en%22%20default%3D%22%E4%BC%A0%E7%BB%9F%E4%B8%AD%E5%9B%BD%E8%89%B2%22%7D%EF%BC%88%E4%BE%8B%E5%A6%82%EF%BC%9A%7Bargument%20name%3D%22example_color_1_en%22%20default%3D%22%E5%A4%A9%E9%9D%92%22%7D%E3%80%81%7Bargument%20name%3D%22example_color_2_en%22%20default%3D%22%E8%83%AD%E8%84%82%22%7D%E3%80%81%7Bargument%20name%3D%22example_color_3_en%22%20default%3D%22%E9%BB%9B%E8%9E%BA%22%7D%EF%BC%89%EF%BC%8C%E5%B9%B6%E9%85%8D%E4%BB%A5%E7%9B%B8%E5%85%B3%E7%9A%84%E5%8F%A4%E5%85%B8%E8%AF%97%E8%AF%8D%E3%80%81%E5%99%A8%E7%89%A9%E6%8F%92%E7%94%BB%E6%88%96%E8%87%AA%E7%84%B6%E9%A3%8E%E5%85%89%E3%80%82)**

---

### No. 25: 单个 HTML 文件中的基于 Web 的 Word 式富文本编辑器
...
一个简洁的中文提示，要求 Gemini 3.0 Pro 构建一个具备关键格式化功能和下载功能的 Word 风格网页富文本编辑器，所有功能都打包到一个 HTML 文件中。

#### 📝 提示词

```
请帮我编写一个基于 Web 的富文本编辑器，类似于 {argument name="target_app_en" default="Word"}，包含其主要功能，所有代码都在一个 HTML 文件中。它应该支持以下功能：标题、段落、左对齐、粗体、斜体、右对齐、下划线、删除线、背景颜色、文本颜色、列表/编号、撤销/重做，最后还有一个下载功能，可以直接生成 HTML。就是这样！
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209173944_kwdxz8_lQts3X1jzvL5Lb7g.jpg" width="600" alt="单个 HTML 文件中的基于 Web 的 Word 式富文本编辑器 - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E8%AF%B7%E5%B8%AE%E6%88%91%E7%BC%96%E5%86%99%E4%B8%80%E4%B8%AA%E5%9F%BA%E4%BA%8E%20Web%20%E7%9A%84%E5%AF%8C%E6%96%87%E6%9C%AC%E7%BC%96%E8%BE%91%E5%99%A8%EF%BC%8C%E7%B1%BB%E4%BC%BC%E4%BA%8E%20%7Bargument%20name%3D%22target_app_en%22%20default%3D%22Word%22%7D%EF%BC%8C%E5%8C%85%E5%90%AB%E5%85%B6%E4%B8%BB%E8%A6%81%E5%8A%9F%E8%83%BD%EF%BC%8C%E6%89%80%E6%9C%89%E4%BB%A3%E7%A0%81%E9%83%BD%E5%9C%A8%E4%B8%80%E4%B8%AA%20HTML%20%E6%96%87%E4%BB%B6%E4%B8%AD%E3%80%82%E5%AE%83%E5%BA%94%E8%AF%A5%E6%94%AF%E6%8C%81%E4%BB%A5%E4%B8%8B%E5%8A%9F%E8%83%BD%EF%BC%9A%E6%A0%87%E9%A2%98%E3%80%81%E6%AE%B5%E8%90%BD%E3%80%81%E5%B7%A6%E5%AF%B9%E9%BD%90%E3%80%81%E7%B2%97%E4%BD%93%E3%80%81%E6%96%9C%E4%BD%93%E3%80%81%E5%8F%B3%E5%AF%B9%E9%BD%90%E3%80%81%E4%B8%8B%E5%88%92%E7%BA%BF%E3%80%81%E5%88%A0%E9%99%A4%E7%BA%BF%E3%80%81%E8%83%8C%E6%99%AF%E9%A2%9C%E8%89%B2%E3%80%81%E6%96%87%E6%9C%AC%E9%A2%9C%E8%89%B2%E3%80%81%E5%88%97%E8%A1%A8%2F%E7%BC%96%E5%8F%B7%E3%80%81%E6%92%A4%E9%94%80%2F%E9%87%8D%E5%81%9A%EF%BC%8C%E6%9C%80%E5%90%8E%E8%BF%98%E6%9C%89%E4%B8%80%E4%B8%AA%E4%B8%8B%E8%BD%BD%E5%8A%9F%E8%83%BD%EF%BC%8C%E5%8F%AF%E4%BB%A5%E7%9B%B4%E6%8E%A5%E7%94%9F%E6%88%90%20HTML%E3%80%82%E5%B0%B1%E6%98%AF%E8%BF%99%E6%A0%B7%EF%BC%81)**

---

### No. 26: 中国 Twitter KOL 排行榜着陆页
...
一个中文提示，指示 Gemini 扮演一位具有审美技能的前端工程师，使用 Tailwind CSS 和 HTML5 为一个中文 Twitter KOL 排名网站创建一个深色、高对比度的着陆页。

#### 📝 提示词

```
作为一名对美学有强烈追求的前端工程师，请为名为“{argument name="site_name_en" default="Chinese Twitter KOL Ranking"}”的网站创建一个着陆页。最大化设计感，采用极简配色方案、深色模式和高对比度。从网络获取数据源。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209256210_9yuf3c_nSwhmffYWeL8BVnG.jpg" width="600" alt="中国 Twitter KOL 排行榜着陆页 - Image 1">
</div>
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E4%BD%9C%E4%B8%BA%E4%B8%80%E5%90%8D%E5%AF%B9%E7%BE%8E%E5%AD%A6%E6%9C%89%E5%BC%BA%E7%83%88%E8%BF%BD%E6%B1%82%E7%9A%84%E5%89%8D%E7%AB%AF%E5%B7%A5%E7%A8%8B%E5%B8%88%EF%BC%8C%E8%AF%B7%E4%B8%BA%E5%90%8D%E4%B8%BA%E2%80%9C%7Bargument%20name%3D%22site_name_en%22%20default%3D%22Chinese%20Twitter%20KOL%20Ranking%22%7D%E2%80%9D%E7%9A%84%E7%BD%91%E7%AB%99%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E7%9D%80%E9%99%86%E9%A1%B5%E3%80%82%E6%9C%80%E5%A4%A7%E5%8C%96%E8%AE%BE%E8%AE%A1%E6%84%9F%EF%BC%8C%E9%87%87%E7%94%A8%E6%9E%81%E7%AE%80%E9%85%8D%E8%89%B2%E6%96%B9%E6%A1%88%E3%80%81%E6%B7%B1%E8%89%B2%E6%A8%A1%E5%BC%8F%E5%92%8C%E9%AB%98%E5%AF%B9%E6%AF%94%E5%BA%A6%E3%80%82%E4%BB%8E%E7%BD%91%E7%BB%9C%E8%8E%B7%E5%8F%96%E6%95%B0%E6%8D%AE%E6%BA%90%E3%80%82%0A%0A%E4%BD%BF%E7%94%A8%20Tailwind%20CSS%20%2B%20HTML5%EF%BC%8C%E6%B7%BB%E5%8A%A0%E5%8A%A8%E7%94%BB%EF%BC%8C%E5%B9%B6%E7%9B%B4%E6%8E%A5%E8%BE%93%E5%87%BA%20HTML%20%E4%BB%A3%E7%A0%81%E3%80%82)**
...
一个简单的 Gemini 提示，用于生成一个通过绘本学习英语的网页应用，该应用之后可以通过 Gemini 驱动的互动课程进行增强。

#### 📝 提示词

```
创作一本学习 {argument name="learning_subject" default="英语"} 的图画书。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E5%88%9B%E4%BD%9C%E4%B8%80%E6%9C%AC%E5%AD%A6%E4%B9%A0%20%7Bargument%20name%3D%22learning_subject%22%20default%3D%22%E8%8B%B1%E8%AF%AD%22%7D%20%E7%9A%84%E5%9B%BE%E7%94%BB%E4%B9%A6%E3%80%82)**
...
A short Chinese prompt asking Gemini to create an animation demonstrating how capacitive touchscreens work, suitable for educational visualizations.

#### 📝 提示词

```
Create an animation demonstrating the capacitive principle of a touch screen.
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209257588_krlosw_t-wuNVWr2kNHojNd.jpg" width="600" alt="Capacitive touchscreen principle animation - Image 1">
</div>

#### 📌 详情

- **作者:** [松果先森](https://x.com/songguoxiansen)
- **来源:** [Twitter Post](https://x.com/songguoxiansen/status/1991031879156576326)
- **发布时间:** 2025年11月19日
- **多语言:** zh

**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=Create%20an%20animation%20demonstrating%20the%20capacitive%20principle%20of%20a%20touch%20screen.)**
...
一个简短的中文提示，用于生成抖音推荐算法的动画演示；虽然侧重于动画，但它也可以在网页环境中使用。

#### 📝 提示词

```
为 {argument name="platform_name_en" default="抖音"} 的推荐算法创建一个演示动画。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E4%B8%BA%20%7Bargument%20name%3D%22platform_name_en%22%20default%3D%22%E6%8A%96%E9%9F%B3%22%7D%20%E7%9A%84%E6%8E%A8%E8%8D%90%E7%AE%97%E6%B3%95%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E6%BC%94%E7%A4%BA%E5%8A%A8%E7%94%BB%E3%80%82)**
...
一个简洁的 Gemini 提示词，用于生成一个动画多级齿轮联动系统，其中转动主齿轮会按比例带动所有其他齿轮，适合作为 SVG 或 canvas 演示。
...
一个英文提示片段，指示 Gemini 实现一个高端的瑞士现代风格的单文件 React 组件着陆页，该着陆页遵循严格的规范，并采用瑞士现代和 Bento 布局概念。
...
根据稍后提供的 {argument name="input_text_en" default="Input Text"}，严格遵循以下规范，用 React（单文件）实现一个高质量的着陆页。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209183164_ff2fxj_G6EeVp4bMAE1rkh.jpg" width="600" alt="React 高端瑞士风格着陆页生成器 - Image 1">
</div>

##### Image 2

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209185261_u9bsts_G6EeVogaQAA3ryy.jpg" width="600" alt="React 高端瑞士风格着陆页生成器 - Image 2">
</div>

##### Image 3

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209191329_c5zs4w_G6EeVp2bMAIw9A4.jpg" width="600" alt="React 高端瑞士风格着陆页生成器 - Image 3">
</div>

##### Image 4

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209194378_bqwb5i_G6EeVp7bkAA4BZ9.jpg" width="600" alt="React 高端瑞士风格着陆页生成器 - Image 4">
</div>
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209235569_ubbhh8_hniRordigEgw3eLQ.jpg" width="600" alt="玻璃拟物霓虹界面 UI - Image 1">
</div>
...
### No. 34: 特斯拉 FSD 道路识别的交互式 SVG 演示

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 描述

一个提示，指示 Gemini 使用 SVG 绘制一个动态、交互式的演示，展示 Tesla FSD 如何识别道路。
...
### No. 35: 重建 GitHub 的 React 项目页面 UI
...
```
构建 {project_name_en, default="React"} 的 GitHub 页面。
```
...
```
在 three.js 中创建一个场景。
它将是一个博物馆，墙上挂着画作，你可以像玩游戏一样在博物馆大厅里走动。
将墙壁和地板设为白色。
天花板上会有玻璃，透过玻璃可以看到天空。
在大厅中央放置白色方块。
```
...
### No. 37: 从图片生成 Three.js 体素艺术场景的提示

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

#### 📖 描述

一个用于 Gemini 3 的编码提示，以生成一个受上传图片启发的 Three.js 体素艺术场景，并将所有代码输出为一个单页文件。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209269076_pv0z04_ViPc6k-OigB0DvZy.jpg" width="600" alt="从图片生成 Three.js 体素艺术场景的提示 - Image 1">
</div>
...
```
构建一个 3D {argument name="puzzle_type_en" default="魔方"}，包含一个用于打乱魔方的“混合”按钮，以及一个用于解开谜题的“解决”按钮。同时允许用户手动操作并自行解开谜题。
```
...
### No. 39: Gemini 中类似 CapCut 的视频编辑器 UI
...
一个非常简单的高级提示，用于使用 Gemini 设计一个 CapCut 风格的视频编辑应用程序界面。
...
```
请在一个 HTML 文件中创建一个功能齐全的 {argument name="game_type_en" default="台球游戏"}。
```
...
一个提示，要求 Gemini 3.0 Pro 创建一个 Xbox 控制器的 SVG 图像，适用于嵌入网页或 UI 组件。
...
```
制作一个新粗野主义网页，使其极具创意并尽可能突破界限。添加平滑滚动动画、炫酷色彩和 Tailwind CSS 样式。使其完全响应式。页面标题为 {argument name="page_title" default="dorksense"}。
```
...
**[👉 立即尝试 →](https://youmind.com/gemini-3-prompts?prompt=%E5%88%B6%E4%BD%9C%E4%B8%80%E4%B8%AA%E6%96%B0%E7%B2%97%E9%87%8E%E4%B8%BB%E4%B9%89%E7%BD%91%E9%A1%B5%EF%BC%8C%E4%BD%BF%E5%85%B6%E6%9E%81%E5%85%B7%E5%88%9B%E6%84%8F%E5%B9%B6%E5%B0%BD%E5%8F%AF%E8%83%BD%E7%AA%81%E7%A0%B4%E7%95%8C%E9%99%90%E3%80%82%E6%B7%BB%E5%8A%A0%E5%B9%B3%E6%BB%91%E6%BB%9A%E5%8A%A8%E5%8A%A8%E7%94%BB%E3%80%81%E7%82%AB%E9%85%B7%E8%89%B2%E5%BD%A9%E5%92%8C%20Tailwind%20CSS%20%E6%A0%B7%E5%BC%8F%E3%80%82%E4%BD%BF%E5%85%B6%E5%AE%8C%E5%85%A8%E5%93%8D%E5%BA%94%E5%BC%8F%E3%80%82%E9%A1%B5%E9%9D%A2%E6%A0%87%E9%A2%98%E4%B8%BA%20%7Bargument%20name%3D%22page_title%22%20default%3D%22dorksense%22%7D%E3%80%82)**

---

### No. 45: 纽约天际线 SVG 单 HTML 场景
