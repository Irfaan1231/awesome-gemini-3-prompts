...
| 📝 プロンプト総数 | **45** |
| ⭐ おすすめ | **0** |
| 🔄 最終更新 | **2025年11月27日木曜日 12:21:14 UTC** |
...
```
「感謝祭のチャーリー・ブラウン」のテーマとスタイルでストアを構築してください。
```
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%80%8C%E6%84%9F%E8%AC%9D%E7%A5%AD%E3%81%AE%E3%83%81%E3%83%A3%E3%83%BC%E3%83%AA%E3%83%BC%E3%83%BB%E3%83%96%E3%83%A9%E3%82%A6%E3%83%B3%E3%80%8D%E3%81%AE%E3%83%86%E3%83%BC%E3%83%9E%E3%81%A8%E3%82%B9%E3%82%BF%E3%82%A4%E3%83%AB%E3%81%A7%E3%82%B9%E3%83%88%E3%82%A2%E3%82%92%E6%A7%8B%E7%AF%89%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82)**
...
新しい AI ゲーム向けに、未来的なアニメーション豊富なランディングページをデザインするよう Gemini 3 Pro に依頼する、Claude Code スキル内で使用される英語のプロンプト。
...
### No. 3: ラグジュアリー 3D ウォッチ製品体験ページ (Next.js + Three.js)

![Language-JA](https://img.shields.io/badge/Language-JA-blue)

#### 📖 説明

高級時計向けの豪華な 3D 製品体験ウェブページをデザインするための、詳細な日本語プロンプト。Next.js、Three.js、React Three Fiber、GLSL を使用し、特定のスクロールセクションとシェーダー要件を満たします。

#### 📝 プロンプト

```
高級腕時計の 3D プロダクト体験ページをデザインする。
**ターゲットユーザー:** 富裕層、時計愛好家、30 歳から 50 歳のビジネスパーソン。
**ブランドトーン:** ラグジュアリー × テック (モダンで洗練されたハイエンドな雰囲気)。
スクロール体験 (5 セクション):
ヒーローセクション – 腕時計が暗闇から光の中へゆっくりと現れ、回転する。ホログラフィック効果とフレネル反射をカスタムシェーダーで実装する。
ディテールズーム – 文字盤のクローズアップ。GLSL を使用して、金属的な反射、パララックスマッピング、リアルタイムの光沢を実現する。
メカニズム分解 – 時計が分解され、内部のムーブメントが空間に浮かぶ。ディスプレイスメントシェーダーでエネルギーフィールド効果を実現し、各パーツにグロー効果を追加する。
マテリアル体験 – さまざまなマテリアルのバリエーションを切り替える。PBR シェーダーで、金属感、ガラスの屈折、チタンのマットな質感を物理ベースで表現する。
...
WebCodecs を使用してエディターを構築し、「ゼルダの伝説 ブレス オブ ザ ワイルド」のゲームプレイをキャプチャする、ベテラン ゲーム プログラミング マスターになりきるユーモラスな中国語プロンプト。

#### 📝 プロンプト

```
あなたはベテランのゲームプログラミングマスターです。WebCodecs をレンダリングモジュールとして使用するエディターの作成を手伝ってください。Switch の電源を入れ、{argument name="game_title_en" default="The Legend of Zelda: Breath of the Wild"} を挿入します。カートリッジをなめないように注意してください。少し苦いです。プロ仕様のキャプチャカードを使用してビデオをキャプチャし、忘れられた神殿のチャレンジを完了し、風の爆弾を使用してください。これらすべてを 60 秒の時間制限内で行ってください。
```
...
Gemini 3 Pro を使用して、Three.js、Anime.js、Tailwind で高級スマートウォッチのランディング ページを構築し、さらに高度なアニメーションとインタラクションを備えた複数セクションのスクロール サイトに改良するための、詳細な多段階プロンプト シーケンス。

#### 📝 プロンプト

```
Three.js、Anime.js、Tailwind を使用して、{argument name="product_type_en" default="高級スマートウォッチ"} ページの HTML ファイルを 1 つ作成します。3D の {argument name="main_object_en" default="時計"} モデル、{argument name="main_object_background_en" default="ベージュの時計"} を表示する丸い穴のある暗いテクスチャのオーバーレイを作成し、ページ読み込み時にヘッダーと大きな数字がスライドインするようにアニメーション化します。

ページをよりプロフェッショナルにします。静的な穴を、読み込み時に開くアイリスに置き換えます。{argument name="focus_area_en" default="時計の文字盤"} の上に反射のあるガラスドームを追加し、金属素材を改善し、マウスの視差効果を追加してカーソルに合わせて {argument name="parallax_target_en" default="時計"} が回転するようにし、{argument name="dial_area_en" default="時計の文字盤"} に時刻とフィットネスリングを描画します。

単一の画面を複数セクションのスクロールサイトに変換します。ユーザーがスクロールすると、3D の {argument name="scroll_object_en" default="時計"} が各セクションに合わせて移動および回転するようにアニメーション化します。テキストがそれらの上をスクロールする間、3D キャンバスと背景は固定されたままにし、{argument name="moving_element_en" default="時計"} のみが移動するようにします。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209174368_jdx5gi_6A51eMDR7nvxQOPd.jpg" width="600" alt="アニメーションセクション付きの高級スマートウォッチ Three.js ランディングページ - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=Three.js%E3%80%81Anime.js%E3%80%81Tailwind%20%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%A6%E3%80%81%7Bargument%20name%3D%22product_type_en%22%20default%3D%22%E9%AB%98%E7%B4%9A%E3%82%B9%E3%83%9E%E3%83%BC%E3%83%88%E3%82%A6%E3%82%A9%E3%83%83%E3%83%81%22%7D%20%E3%83%9A%E3%83%BC%E3%82%B8%E3%81%AE%20HTML%20%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%E3%82%92%201%20%E3%81%A4%E4%BD%9C%E6%88%90%E3%81%97%E3%81%BE%E3%81%99%E3%80%823D%20%E3%81%AE%20%7Bargument%20name%3D%22main_object_en%22%20default%3D%22%E6%99%82%E8%A8%88%22%7D%20%E3%83%A2%E3%83%87%E3%83%AB%E3%80%81%7Bargument%20name%3D%22main_object_background_en%22%20default%3D%22%E3%83%99%E3%83%BC%E3%82%B8%E3%83%A5%E3%81%AE%E6%99%82%E8%A8%88%22%7D%20%E3%82%92%E8%A1%A8%E7%A4%BA%E3%81%99%E3%82%8B%E4%B8%B8%E3%81%84%E7%A9%B4%E3%81%AE%E3%81%82%E3%82%8B%E6%9A%97%E3%81%84%E3%83%86%E3%82%AF%E3%82%B9%E3%83%81%E3%83%A3%E3%81%AE%E3%82%AA%E3%83%BC%E3%83%90%E3%83%BC%E3%83%AC%E3%82%A4%E3%82%92%E4%BD%9C%E6%88%90%E3%81%97%E3%80%81%E3%83%9A%E3%83%BC%E3%82%B8%E8%AA%AD%E3%81%BF%E8%BE%BC%E3%81%BF%E6%99%82%E3%81%AB%E3%83%98%E3%83%83%E3%83%80%E3%83%BC%E3%81%A8%E5%A4%A7%E3%81%8D%E3%81%AA%E6%95%B0%E5%AD%97%E3%81%8C%E3%82%B9%E3%83%A9%E3%82%A4%E3%83%89%E3%82%A4%E3%83%B3%E3%81%99%E3%82%8B%E3%82%88%E3%81%86%E3%81%AB%E3%82%A2%E3%83%8B%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%
E3%82%B7%E3%83%A7%E3%83%B3%E3%81%AB%E5%90%88%E3%82%8F%E3%81%9B%E3%81%A6%E7%A7%BB%E5%8B%95%E3%81%8A%E3%82%88%E3%81%B3%E5%9B%9E%E8%BB%A2%E3%81%99%E3%82%8B%E3%82%88%E3%81%86%E3%81%AB%E3%82%A2%E3%83%8B%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E5%8C%96%E3%81%97%E3%81%BE%E3%81%99%E3%80%82%E3%83%86%E3%82%AD%E3%82%B9%E3%83%88%E3%81%8C%E3%81%9D%E3%82%8C%E3%82%89%E3%81%AE%E4%B8%8A%E3%82%92%E3%82%B9%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%AB%E3%81%99%E3%82%8B%E9%96%93%E3%80%813D%20%E3%82%AD%E3%83%A3%E3%83%B3%E3%83%90%E3%82%B9%E3%81%A8%E8%83%8C%E6%99%AF%E3%81%AF%E5%9B%BA%E5%AE%9A%E3%81%95%E3%82%8C%E3%81%9F%E3%81%BE%E3%81%BE%E3%81%AB%E3%81%97%E3%80%81%7Bargument%20name%3D%22moving_element_en%22%20default%3D%22%E6%99%82%E8%A8%88%22%7D%20%E3%81%AE%E3%81%BF%E3%81%8C%E7%A7%BB%E5%8B%95%E3%81%99%E3%82%8B%E3%82%88%E3%81%86%E3%81%AB%E3%81%97%E3%81%BE%E3%81%99%E3%80%82%0A%0A-%20%E5%9B%BA%E5%AE%9A%E3%82%AD%E3%83%A3%E3%83%B3%E3%83%90%E3%82%B9%3A%20%E3%82%AD%E3%83%A3%E3%83%B3%E3%83%90%E3%82%B9%E3%82%92%E9%85%8D%E7%BD%AE%E3%81%99%E3%82%8B)**

---

### No. 6: ダウンロードボタン付きのシンプルな SVG アイコンを 40 個生成
...
### No. 7: ボクセルアートのパゴダガーデン単一ファイル HTML シーン
...
カラフルなボクセルアートのパゴダ庭園環境を、Chrome で動作する完全に自己完結型の HTML ファイルとして設計するための英語のプロンプト。ボクセル/WebGL ライブラリは任意。

#### 📝 プロンプト

```
華やかな庭園の中に、装飾豊かな{argument name="main_structure_en" default="五重塔"}を配した、精巧なボクセルアート環境をデザインしてください。
特に{argument name="key_tree_en" default="桜の木"}など、多様な植生を含め、構図が生き生きとして色彩豊かで、視覚的に印象的なものになるようにしてください。
お好みのボクセルまたは WebGL ライブラリを使用してください。ただし、プロジェクト全体を単一の自己完結型 HTML ファイルとして納品し、Chrome に直接貼り付けて開けるようにしてください。
```
...
```
未来的なダークモードの暗号通貨データダッシュボードを再現します。全体的に高コントラストのオブシディアン背景、グラデーションのアウトラインを持つグラスモーフィズム UI エレメント、スリムな Inter 書体、ネオンライティング効果のある金融データビジュアライゼーションを使用してください。
```
...
```
メインホイール、中央ベアリング、サポートフレーム、駆動ギアセット、および水平を保つための逆自己水平機構を備えた 8〜12 個のゴンドラを含む SVG 観覧車の機械アニメーションをデザインしてください。すべてのリンケージとギア伝達は正確でなければならず、完全な機械駆動チェーンとゴンドラを水平に保つ逆回転ロジックを示す必要があります。HTML 形式で出力してください。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209214086_7c83l2_fGU454kI2vu8dFjI.jpg" width="600" alt="HTML で SVG 観覧車のメカニカルアニメーション - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%83%A1%E3%82%A4%E3%83%B3%E3%83%9B%E3%82%A4%E3%83%BC%E3%83%AB%E3%80%81%E4%B8%AD%E5%A4%AE%E3%83%99%E3%82%A2%E3%83%AA%E3%83%B3%E3%82%B0%E3%80%81%E3%82%B5%E3%83%9D%E3%83%BC%E3%83%
E3%82%A4%E3%83%B3%E3%82%BF%E3%83%A9%E3%82%AF%E3%83%86%E3%82%A3%E3%83%96%E3%81%AA%20SVG%20%E3%83%9C%E3%83%87%E3%82%A3%EF%BC%88%E5%89%8D%E9%9D%A2%2F%E8%83%8C%E9%9D%A2%E3%83%93%E3%83%A5%E3%83%BC%E3%80%81%E7%AD%8B%E8%82%89%E3%82%92%E3%82%AF%E3%83%AA%E3%83%83%E3%82%AF%E3%81%99%E3%82%8B%E3%81%A8%E3%83%8F%E3%82%A4%E3%83%A9%E3%82%A4%E3%83%88%E8%A1%A8%E7%A4%BA%EF%BC%89%E3%80%81%E4%B8%AD%E5%9B%BD%E8%AA%9E%E3%81%AE%E3%83%95%E3%82%A3%E3%83%AB%E3%82%BF%E3%83%BC%EF%BC%88%E6%80%A7%E5%88%A5%2F%E3%83%AC%E3%83%99%E3%83%AB%2F%E5%99%A8%E5%85%B7%EF%BC%89%E3%80%81%E3%82%A8%E3%82%AF%E3%82%B5%E3%82%B5%E3%82%A4%E3%82%BA%E3%82%AB%E3%83%BC%E3%83%89%E3%82%92%E5%82%99%E3%81%88%E3%81%9F%20Keep%20%E3%82%B9%E3%82%BF%E3%82%A4%E3%83%AB%E3%81%AE%E4%B8%AD%E5%9B%BD%E8%AA%9E%E3%83%95%E3%82%A3%E3%83%83%E3%83%88%E3%83%8D%E3%82%B9%E3%83%9A%E3%83%BC%E3%82%B8%E3%82%92%E6%A7%8B%E7%AF%89%E3%81%97%E3%81%BE%E3%81%99%E3%80%82Tailwind%20%2B%20JavaScript%20%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%A6%E3%80%81%E5%8D%98%E4%B8%80%E3%81%AE%20HTML%20%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%E3%81%A8%E3%81%97%E3%81%A6%E6%8F%90%E4%BE%9B%E3%81%97%E3%81%BE%E3%81%99%E3%80%82)**

---

### No. 12: ネオ・ブルータリズム ウェブサイト デザイン プロンプト

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

#### 📖 説明

スムーズなスクロールアニメーション、鮮やかな色彩、レスポンシブな Tailwind ベースのレイアウトを備えたネオブルータリズム様式のウェブサイトを作成するための短い英語のプロンプト。

#### 📝 プロンプト

```
創造性の限界を押し広げるネオ・ブルータリズムのウェブサイトを作成しましょう。スムーズなスクロールアニメーション、鮮やかな色彩、Tailwind ES スタイルを取り入れ、完全にレスポンシブに対応させます。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209207369_aa3rub_Com2rFXK131nN-WJ.jpg" width="600" alt="ネオ・ブルータリズム ウェブサイト デザイン プロンプト - Image 1">
</div>
...
```
レトロなポラロイド風のウェブカメラアプリケーションを開発してください。ページ左下にはポラロイドカメラのモデルを配置し、ユーザーのウェブカメラを呼び出してリアルタイムプレビューを表示できるようにします。シャッターをクリックすると、カメラ上部から「印画紙」がゆっくりと出てきて、写真が最初はぼやけていた状態から徐々に鮮明に現像されます。ユーザーは、完全に現像された写真をカメラ上部からページの任意の位置にドラッグして、「写真コラージュウォール」のような自由なレイアウトを作成できます。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209203730_z4nncu_80rs2O9LInawTSTj.jpg" width="600" alt="レトロなポラロイドカメラのウェブサイトと写真ウォール - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%83%AC%E3%83%88%E3%83%AD%E3%81%AA%E3%83%9D%E3%83%A9%E3%83%AD%E3%82%A4%E3%83%89%E9%A2%A8%E3%81%AE%E3%82%A6%E3%82%A7%E3%83%96%E3%82%AB%E3%83%A1%E3%83%A9%E3%82%A2%E3%83%97%E3%83%AA%E3%82%B1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E9%96%8B%E7%99%BA%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%
![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

ユーザーが毎朝夢を記録し、ステッカーイラストをコラージュして、最終的にタロットのような夢のカードを生成する中国のウェブアプリを構築するためのプロンプト。
...
### No. 15: Gemini と React を使用した 3D レンガ積みビルダーアプリ
...
Gemini を世界クラスのフロントエンドエンジニアとして、React、Three.js、Tailwind CSS、および Gemini API を使用して Minecraft のような 3D レンガ積みアプリを構築させる、英語システム形式のプロンプト。

#### 📝 プロンプト

```
世界クラスのフロントエンドエンジニアおよび UX デザイナーとして振る舞ってください。React、Three.js（@react-three/fiber）、Tailwind CSS、Google Gemini API（@google/genai）を使用して、「{argument name="application_name_en" default="3D Brick Builder Application"}」を構築してください。
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E4%B8%96%E7%95%8C%E3%82%AF%E3%83%A9%E3%82%B9%E3%81%AE%E3%83%95%E3%83%AD%E3%83%B3%E3%83%88%E3%82%A8%E3%83%B3%E3%83%89%E3%82%A8%E3%83%B3%E3%82%B8%E3%83%8B%E3%82%A2%E3%81%8A%E3%82%88%E3%81%B3%20UX%20%E3%83%87%E3%82%B6%E3%82%A4%E3%83%8A%E3%83%BC%E3%81%A8%E3%81%97%E3%81%A6%E6%8C%AF%E3%82%8B%E8%88%9E%E3%81%A3%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82React%E3%80%81Three.js%EF%BC%88%40react-three%2Ffiber%EF%BC%89%E3%80%81Tailwind%20CSS%E3%80%81Google%20Gemini%20API%EF%BC%88%40google%2Fgenai%EF%BC%89%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%A6%E3%80%81%E3%80%8C%7Bargument%20name%3D%22application_name_en%22%20default%3D%223D%20Brick%20Builder%20Application%22%7D%E3%80%8D%E3%82%92%E6%A7%8B%E7%AF%89%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%0A%0A%23%23%20%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3%E5%93%B2%E5%AD%A6%0A-%20**%E3%83%86%E3%83%BC%E3%83%9E**%3A%20%E3%80%8C%7Bargument%20name%3D%22theme_en%22%20default%3D%22White%20Base%22%7D%E3%80%8D%E3%81%AE%E3%83%A2%E3%83%80%E3%83%B3%E3%81%AA%E7%BE%8E%E5%AD%A6%E3%80%82)**

---

### No. 16: X (Twitter) MBTI アナライザー Web アプリ
...
```
X MBTI アナライザーを作成する: ユーザーがツイートを貼り付けると、フロントエンドがバックエンドを呼び出し (バックエンドは Gemini API を使用して MBTI タイプを推測します)。
デザインスタイルは Linear に準拠し、ダークモードのみで、ミニマリストでありながら高品質な雰囲気と洗練されたディテールを持つものとします。インターフェースは中国語で提供されます。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209249948_o2ejtv_bEBJ9Q-sEm-FuO9_.jpg" width="600" alt="中国の AI 漢服ワードローブ Web アプリ - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=AI%20%E9%A1%94%E4%BA%A4%E6%8F%9B%E3%81%BE%E3%81%9F%E3%81%AF%203D%20%E4%BD%93%E5%9E%8B%E3%83%86%E3%82%AF%E3%83%8E%E3%83%AD%E3%82%B8%E3%83%BC%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%9F%20AI%20%E6%BC%A2%E6%9C%8D%E3%83%AF%E3%83%BC%E3%83%89%E3%83%AD%E3%83%BC%E3%83%96%E3%82%A2%E3%83%97%E3%83%AA%E3%82%B1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E7%94%9F%E6%88%90%E3%81%97%E3%81%BE%E3%81%99%E3%80%82%E3%83%A6%E3%83%BC%E3%82%B6%E3%83%BC%E3%81
E3%81%A7%E3%81%8D%E3%81%BE%E3%81%99%E3%80%82)**

---

### No. 19: ギリシャ神話の星座をテーマにした中国語のウェブアプリ

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

Gemini 3 Pro 用のプロンプト。各星や星座を絵本のように表現し、星座の線と神話の登場人物のイラストを組み合わせたシングルページの中国語 Web アプリを構築します。

#### 📝 プロンプト

```
ギリシャ神話に登場する星や星座の物語を絵本の形式で伝えるウェブアプリケーションを生成してください。星座の結びつきを示す線だけでなく、神話の登場人物のイラストも表示するようにしてください。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209254334_uu21fi_fDJNuJlmTIVYVYvr.jpg" width="600" alt="ギリシャ神話の星座をテーマにした中国語のウェブアプリ - Image 1">
</div>
...
伝統的な縁起の良い活動ではなく、若者のライフスタイルに合わせた現代的な日替わりおみくじカードを生成する、サイバーテーマの中国語ウェブアプリを作成するための Gemini プロンプト。

#### 📝 プロンプト

```
若者向けの現代的な日めくりカレンダーとして、サイバーパンク風の中国語 Web アプリケーションを生成します。「結婚に良い日」のような伝統的な項目ではなく、現代の生活シナリオを反映したものにしてください。例：「今日すること：{argument name="today_do_example_1_en" default="仕事をサボる"}、{argument name="today_do_example_2_en" default="ミルクティーを飲む"}、{argument name="today_do_example_3_en" default="告白する"}；今日避けること：{argument name="today_avoid_example_1_en" default="会議"}、{argument name="today_avoid_example_2_en" default="徹夜"}、{argument name="today_avoid_example_3_en" default="大きな決意をする"}。」
```
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E8%8B%A5%E8%80%85%E5%90%91%E3%81%91%E3%81%AE%E7%8F%BE%E4%BB%A3%E7%9A%84%E3%81%AA%E6%97%A5%E3%82%81%E3%81%8F%E3%82%8A%E3%82%AB%E3%83%AC%E3%83%B3%E3%83%80%E3%83%BC%E3%81%A8%E3%81%97%E3%81%A6%E3%80%81%E3%82%B5%E3%82%A4%E3%83%90%E3%83%BC%E3%83%91%E3%83%B3%E3%82%AF%E9%A2%A8%E3%81%AE%E4%B8%AD%E5%9B%BD%E8%AA%9E%20Web%20%E3%82%A2%E3%83%97%E3%83%AA%E3%82%B1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E7%94%9F%E6%88%90%E3%81%97%E3%81%BE%E3%81%99%E3%80%82%E3%80%8C%E7%B5%90%E5%A9%9A%E3%81%AB%E8%89%AF%E3%81%84%E6%97%A5%E3%80%8D%E3%81%AE%E3%82%88%E3%81%86%E3%81%AA%E4%BC%9D%E7%B5%B1%E7%9A%84%E3%81%AA%E9%A0%85%E7%9B%AE%E3%81%A7%E3%81%AF%E3%81%AA%E3%81%8F%E3%80%81%E7%8F%BE%E4%BB%A3%E3%81%AE%E7%94%9F%E6%B4%BB%E3%82%B7%E3%83%8A%E3%83%AA%E3%82%AA%E3%82%92%E5%8F%8D%E6%98%A0%E3%81%97%E3%81%9F%E3%82%82%E3%81%AE%E3%81%AB%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%E4%BE%8B%EF%BC%9A%E3%80%8C%E4%BB%8A%E6%97%A5%E3%81%99%E3%82%8B%E3%81%93%E3%81%A8%EF%BC%9A%7Bargument%20name%3D%22today_do_example_1_en%22%20default%3D%22%E4%BB%95%E4%BA%8B%E3%82%92%E3%82%B5%E3%83%9C%E3%82%8B%22%7D%E3%80%81%7Bargument%20name%3D%22today_do_example_2_en%22%20default%3D%22%E3%83%9F%E3%83%AB%E3%82%AF%E3%83%86%E3%82%A3%E3%83%BC%E3%82%92%E9%A3%B2%E3%82%80%22%7D%E3%80%81%7Bargument%20name%3D%22today_do_example_3_en%22%20default%3D%22%E5%91%8A%E7%99%BD%E3%81%99%E3%82%8B%22%7D%EF%BC%9B%E4%BB%8A%E6%97%A5%E9%81%BF%E3%81%91%E3%82%8B%E3%81%93%E3%81%A8%EF%BC%9A%7Bargument%20name%3D%22today_avoid_example_1_en%22%20default%3D%22%E4%BC%9A%E8%AD%B0%22%7D%E3%80%81%7Bargument%20name%3D%22today_avoid_example_2_en%22%20default%3D%22%E5%BE%B9%E5%A4%9C%22%7D%E3%80%81%7Bargument%20name%3D%22today_avoid_example_3_en%22%20default%3D%22%E5%A4%A7%E3%81%8D%E3%81%AA%E6%B1%BA%E6%84%8F%E3%82%92%E3%81%99%E3%82%8B%22%7D%E3%80%82%E3%80%8D)**

---

### No. 21: レトロなポラロイド風カメラ Web アプリ

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

左下にカメラがあり、ウェブカメラに接続して現像中の写真を排出し、ユーザーがそれらをドラッグしてフォトウォールを形成できる、レトロな Polaroid カメラのウェブアプリを構築するための中国語のプロンプト。

#### 📝 プロンプト

```
レトロなポラロイド風カメラのウェブアプリケーション作成にご協力ください。ページの左下隅に、ウェブカメラに接続してリアルタイムプレビューを表示できるカメラを表示します。シャッターボタンをクリックすると、カメラの上部から印画紙がゆっくりと現れ、写真がぼやけた状態から鮮明になるまで現像されます。ユーザーは、現像された写真をカメラの上からカメラ以外のページ領域にドラッグして、フォトウォールのような効果を作成できます。
```
...
Gemini 3 Pro に、Unreal Bloom を適用した何千ものオーディオ反応型インスタンス化パーティクルに囲まれたレイマーチングされたマンデルバルブ・フラクタルを、単一ファイルで作成するよう依頼する、コンパクトな Three.js/GLSL プロンプト。

#### 📝 プロンプト

```
GLSL でレイマーチングのマンデルバルブ・フラクタルを作成し、{argument name="particle_count_en" default="12,000"} 個のインスタンス化されたパーティクルで囲み、マイクにオーディオ反応するようにして、Unreal Bloom を追加する。
```
...
Gemini 3 Pro に makemepulse スタジオとして振る舞い、AP というクライアントのために、丁寧な実行に重点を置いてウェブサイトを構築するよう指示する、シンプルな指示形式のプロンプト。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209176859_vznbt0_UPKTu2bYW7AZTCBs.jpg" width="600" alt="AP 社の代理店風ウェブサイト - Image 1">
</div>
...
毎日、中国の伝統色を一つずつ紹介し、詩や関連するイラスト、風景を添えるウェブアプリを構築するための Gemini プロンプト。

#### 📝 プロンプト

```
毎日、{argument name="color_system_en" default="伝統的な中国の色"} を1色紹介するウェブアプリケーションを生成します（例：{argument name="example_color_1_en" default="Sky Blue (Tianqing)"}、{argument name="example_color_2_en" default="Crimson (Yanzhi)"}、{argument name="example_color_3_en" default="Dark Green (Dailuo)"}）。関連する古典詩、工芸品のイラスト、または自然の風景を添えます。
```
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E6%AF%8E%E6%97%A5%E3%80%81%7Bargument%20name%3D%22color_system_en%22%20default%3D%22%E4%BC%9D%E7%B5%B1%E7%9A%84%E3%81%AA%E4%B8%AD%E5%9B%BD%E3%81%AE%E8%89%B2%22%7D%20%E3%82%921%E8%89%B2%E7%B4%B9%E4%BB%8B%E3%81%99%E3%82%8B%E3%82%A6%E3%82%A7%E3%83%96%E3%82%A2%E3%83%97%E3%83%AA%E3%82%B1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E7%94%9F%E6%88%90%E3%81%97%E3%81%BE%E3%81%99%EF%BC%88%E4%BE%8B%EF%BC%9A%7Bargument%20name%3D%22example_color_1_en%22%20default%3D%22Sky%20Blue%20(Tianqing)%22%7D%E3%80%81%7Bargument%20name%3D%22example_color_2_en%22%20default%3D%22Crimson%20(Yanzhi)%22%7D%E3%80%81%7Bargument%20name%3D%22example_color_3_en%22%20default%3D%22Dark%20Green%20(Dailuo)%22%7D%EF%BC%89%E3%80%82%E9%96%A2%E9%80%A3%E3%81%99%E3%82%8B%E5%8F%A4%E5%85%B8%E8%A9%A9%E3%80%81%E5%B7%A5%E8%8A%B8%E5%93%81%E3%81%AE%E3%82%A4%E3%83%A9%E3%82%B9%E3%83%88%E3%80%81%E3%81%BE%E3%81%9F%E3%81%AF%E8%87%AA%E7%84%B6%E3%81%AE%E9%A2%A8%E6%99%AF%E3%82%92%E6%B7%BB%E3%81%88%E3%81%BE%E3%81%99%E3%80%82)**

---

### No. 25: 単一の HTML ファイルで動作する、Web ベースの Word のようなリッチテキストエディター

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

Gemini 3.0 Pro に、主要な書式設定機能とダウンロード機能を備えた Word スタイルの Web リッチテキストエディターを、すべて 1 つの HTML ファイルにまとめて構築するよう依頼する簡潔な中国語のプロンプト。

#### 📝 プロンプト

```
Web ベースのリッチテキストエディターを開発するのを手伝ってください。主要な機能を含め、すべてのコードを単一の HTML ファイルに記述してください。見出し、段落、左揃え、太字、斜体、右揃え、下線、取り消し線、背景色、文字色、リスト/番号付け、元に戻す/やり直し、そして最後にダウンロード機能（HTML を直接生成できる）をサポートする必要があります。以上です！
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209173944_kwdxz8_lQts3X1jzvL5Lb7g.jpg" width="600" alt="単一の HTML ファイルで動作する、Web ベースの Word のようなリッチテキストエディター - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=Web%20%E3%83%99%E3%83%BC%E3%82%B9%E3%81%AE%E3%83%AA%E3%83%83%E3%83%81%E3%83%86%E3%82%AD%E3%82%B9%E3%83%88%E3%82%A8%E3%83%87%E3%82%A3%E3%82%BF%E3%83%BC%E3%82%92%E9%96%8B%E7%99%BA%E3%81%99%E3%82%8B%E3%81%AE%E3%82%92%E6%89%8B%E4%BC%9D%E3%81%A3%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%E4%B8%BB%E8%A6%81%E3%81%AA%E6%A9%9F%E8%83%BD%E3%82%92%E5%90%AB%E3%82%81%E3%80%81%E3%81%99%E3%81%B9%E3%81%A6%E3%81%AE%E3%82%B3%E3%83%BC%E3%83%89%E3%82%92%E5%8D%98%E4%B8%80%E3%81%AE%20HTML%20%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%E3%81%AB%E8%A8%98%E8%BF%B0%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%E8%A6%8B%E5%87%BA%E3%81%97%E3%80%81%E6%AE%B5%E8%90%BD%E3%80%81%E5%B7%A6%E6%8F%83%E3%81%88%E3%80%81%E5%A4%AA%E5%AD%97%E3%80%81%E6%96%9C%E4%BD%93%E3%80%81%E5%8F%B3%E6%8F%83%E3%81%88%E3%80%81%E4%B8%8B%E7%B7%9A%E3%80%81%E5%8F%96%E3%82%8A%E6%B6%88%E3%81%97%E7%B7%9A%E3%80%81%E8%83%8C%E6%99%AF%E8%89%B2%E3%80%81%E6%96%87%E5%AD%97%E8%89%B2%E3%80%81%E3%83%AA%E3%82%B9%E3%83%88%2F%E7%95%AA%E5%8F%B7%E4%BB%98%E3%81%91%E3%80%81%E5%85%83%E3%81%AB%E6%88%BB%E3%81%99%2F%E3%82%84%E3%82%8A%E7%9B%B4%E3%81%97%E3%80%81%E3%81%9D%E3%81%97%E3%81%A6%E6%9C%80%E5%BE%8C%E3%81%AB%E3%83%80%E3%82%A6%E3%83%B3%E3%83%AD%E3%83%BC%E3%83%89%E6%A9%9F%E8%83%BD%EF%BC%88HTML%20%E3%82%92%E7%9B%B4%E6%8E%A5%E7%94%9F%E6%88%90%E3%81%A7%E3%81%8D%E3%82%8B%EF%BC%89%E3%82%92%E3%82%B5%E3%83%9D%E3%83%BC%E3%83%88%E3%81%99%E3%82%8B%E5%BF%85%E8%A6%81%E3%81%8C%E3%81%82%E3%82%8A%E3%81%BE%E3%81%99%E3%80%82%E4%BB%A5%E4%B8%8A%E3%81%A7%E3%81%99%EF%BC%81)**

---

### No. 26: 中国の Twitter KOL ランキング ランディングページ
...
Gemini に、美的センスに優れたフロントエンドエンジニアとして振る舞い、Tailwind CSS と HTML5 を使用して、中国の Twitter KOL ランキングサイト向けのダークで高コントラストなランディングページを作成するよう指示する中国語のプロンプト。

#### 📝 プロンプト

```
美的センスに優れたフロントエンド エンジニアとして、「{argument name="site_name_en" default="Chinese Twitter KOL Ranking"}」というウェブサイトのランディング ページを作成してください。デザイン性を最大限に高め、ミニマルな配色、ダーク モード、高コントラストを使用してください。データ ソースはウェブから取得してください。
Tailwind CSS + HTML5 を使用し、アニメーションを追加して、HTML コードを直接出力してください。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209256210_9yuf3c_nSwhmffYWeL8BVnG.jpg" width="600" alt="中国の Twitter KOL ランキング ランディングページ - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E7%BE%8E%E7%9A%84%E3%82%BB%E3%83%B3%E3%82%B9%E3%81%AB%E5%84%AA%E3%82%8C%E3%81%9F%E3%83%95%E3%83%AD%E3%83%B3%E3%83%88%E3%82%A8%E3%83%B3%E3%83%89%20%E3%82%A8%E3%83%B3%E3%82%B8%E3%83%8B%E3%82%A2%E3%81%A8%E3%81%97%E3%81%A6%E3%80%81%E3%80%8C%7Bargument%20name%3D%22site_name_en%22%20default%3D%22Chinese%20Twitter%20KOL%20Ranking%22%7D%E3%80%8D%E3%81%A8%E3%81%84%E3%81%86%E3%82%A6%E3%82%A7%E3%83%96%E3%82%B5%E3%82%A4%E3%83%88%E3%81%AE%E3%83%A9%E3%83%B3%E3%83%87%E3%82%A3%E3%83%B3%E3%82%B0%20%E3%83%9A%E3%83%BC%E3%82%B8%E3%82%92%E4%BD%9C%E6%88%90%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3%E6%80%A7%E3%82%92%E6%9C%80%E5%A4%A7%E9%99%90%E3%81%AB%E9%AB%98%E3%82%81%E3%80%81%E3%83%9F%E3%83%8B%E3%83%9E%E3%83%AB%E3%81%AA%E9%85%8D%E8%89%B2%E3%80%81%E3%83%80%E3%83%BC%E3%82%AF%20%E3%83%A2%E3%83%BC%E3%83%89%E3%80%81%E9%AB%98%E3%82%B3%E3%83%B3%E3%83%88%E3%83%A9%E3%82%B9%E3%83%88%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%E3%83%87%E3%83%BC%E3%82%BF%20%E3%82%BD%E3%83%BC%E3%82%B9%E3%81%AF%E3%82%A6%E3%82%A7%E3%83%96%E3%81%8B%E3%82%89%E5%8F%96%E5%BE%97%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82%0ATailwind%20CSS%20%2B%20HTML5%20%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%80%81%E3%82%A2%E3%83%8B%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E8%BF%BD%E5%8A%A0%E3%81%97%E3%81%A6%E3%80%81HTML%20%E3%82%B3%E3%83%BC%E3%83%89%E3%82%92%E7%9B%B4%E6%8E%A5%E5%87%BA%E5%8A%9B%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82)**

---

### No. 27: 英語絵本学習 Web アプリ
...
絵本で英語を学習できるウェブアプリケーションを生成するためのシンプルな Gemini プロンプト。このアプリケーションは、後から Gemini を活用したインタラクティブなレッスンで強化できます。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209248163_oeazqe_wznIvkBORVz7dPEt.jpg" width="600" alt="英語絵本学習 Web アプリ - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%7Bargument%20name%3D%22learning_subject%22%20default%3D%22%E8%8B%B1%E8%AA%9E%22%7D%E5%AD%A6%E7%BF%92%E7%94%A8%E3%81%AE%E7%B5%B5%E6%9C%AC%E3%82%92%E4%BD%9C%E6%88%90%E3%81%99%E3%82%8B)**

---

### No. 28: 静電容量式タッチスクリーン原理アニメーション

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

静電容量式タッチスクリーンがどのように機能するかを示すアニメーションを Gemini に作成してもらうための短い中国語のプロンプト。教育用ビジュアライゼーションに適しています。

#### 📝 プロンプト

```
タッチスクリーンの静電容量原理を示すアニメーションを作成してください。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209257588_krlosw_t-wuNVWr2kNHojNd.jpg" width="600" alt="静電容量式タッチスクリーン原理アニメーション - Image 1">
</div>

#### 📌 詳細

- **作者:** [松果先森](https://x.com/songguoxiansen)
- **ソース:** [Twitter Post](https://x.com/songguoxiansen/status/1991031879156576326)
- **公開日:** 2025年11月19日
- **言語:** zh

**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%82%BF%E3%83%83%E3%83%81%E3%82%B9%E3%82%AF%E3%83%AA%E3%83%BC%E3%83%B3%E3%81%AE%E9%9D%99%E9%9B%BB%E5%AE%B9%E9%87%8F%E5%8E%9F%E7%90%86%E3%82%92%E7%A4%BA%E3%81%99%E3%82%A2%E3%83%8B%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%82%92%E4%BD%9C%E6%88%90%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82)**

---

### No. 29: Douyin レコメンデーションアルゴリズムデモアニメーション
...
Douyin のレコメンデーションアルゴリズムのアニメーションデモを生成するための短い中国語プロンプト。アニメーションに焦点を当てていますが、Web コンテキストでも使用できます。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209245189_xk7l00_GCkbyVRynHwDSc_u.jpg" width="600" alt="Douyin レコメンデーションアルゴリズムデモアニメーション - Image 1">
</div>
...
### No. 30: 多段ギア連動システムのアニメーション

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

メインギアを回すと他のすべてのギアが比例して駆動する、アニメーション化された多段階ギア連動システムを生成するための簡潔な Gemini プロンプト。SVG またはキャンバスデモに適しています。
...
### No. 31: 爆発的な視覚効果を伴うパララックススクロールのホームページ

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

#### 📖 説明

階層化された背景、スムーズなトランジション、インタラクティブなアニメーション要素を備えた、視覚的に印象的なパララックススクロールウェブサイトのホームページを生成するための英語のプロンプト。

#### 📝 プロンプト

```
スクロール時に異なる速度で動くレイヤー化された背景、スムーズなトランジション、アニメーションでポップアップするインタラクティブな要素など、爆発的な視覚効果を備えたパララックススクロール Web サイトを作成します。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209251231_c47kvt_f7sUEhYX0T-TA08T.jpg" width="600" alt="爆発的な視覚効果を伴うパララックススクロールのホームページ - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%82%B9%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%AB%E6%99%82%E3%81%AB%E7%95%B0%E3%81%AA%E3%82%8B%E9%80%9F%E5%BA%A6%E3%81%A7%E5%8B%95%E3%81%8F%E3%83%AC%E3%82%A4%E3%83%A4%E3%83%BC%E5%8C%96%E3%81%95%E3%82%8C%E3%81%9F%E8%83%8C%E6%99%AF%E3%80%81%E3%82%B9%E3%83%A0%E3%83%BC%E3%82%BA%E3%81%AA%E3%83%88%E3%83%A9%E3%83%B3%E3%82%B8%E3%82%B7%E3%83%A7%E3%83%B3%E3%80%81%E3%82%A2%E3%83%8B%E3%83%A1%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3%E3%81%A7%E3%83%9D%E3%83%83%E3%83%97%E3%82%A2%E3%83%83%E3%83%97%E3%81%99%E3%82%8B%E3%82%A4%E3%83%B3%E3%82%BF%E3%83%A9%E3%82%AF%E3%83%86%E3%82%A3%E3%83%96%E3%81%AA%E8%A6%81%E7%B4%A0%E3%81%AA%E3%81%A9%E3%80%81%E7%88%86%E7%99%BA%E7%9A%84%E3%81%AA%E8%A6%96%E8%A6%9A%E5%8A%B9%E6%9E%9C%E3%82%92%E5%82%99%E3%81%88%E3%81%9F%E3%83%91%E3%83%A9%E3%83%A9%E3%83%83%E3%82%AF%E3%82%B9%E3%82%B9%E3%82%AF%E3%83%AD%E3%83%BC%E3%83%AB%20Web%20%E3%82%B5%E3%82%A4%E3%83%88%E3%82%92%E4%BD%9C%E6%88%90%E3%81%97%E3%81%BE%E3%81%99%E3%80%82)**

---

### No. 32: React で作られたハイエンドなスイススタイルランディングページジェネレーター
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209183164_ff2fxj_G6EeVp4bMAE1rkh.jpg" width="600" alt="React で作られたハイエンドなスイススタイルランディングページジェネレーター - Image 1">
</div>

##### Image 2

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209185261_u9bsts_G6EeVogaQAA3ryy.jpg" width="600" alt="React で作られたハイエンドなスイススタイルランディングページジェネレーター - Image 2">
</div>

##### Image 3

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209191329_c5zs4w_G6EeVp2bMAIw9A4.jpg" width="600" alt="React で作られたハイエンドなスイススタイルランディングページジェネレーター - Image 3">
</div>

##### Image 4

<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209194378_bqwb5i_G6EeVp7bkAA4BZ9.jpg" width="600" alt="React で作られたハイエンドなスイススタイルランディングページジェネレーター - Image 4">
</div>
...
### No. 33: グラスモーフィズム ネオン インターフェース UI
...
### No. 34: Tesla FSD の道路認識を示すインタラクティブ SVG デモ

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

Tesla FSD が道路を認識する方法を、SVG を使用して動的かつインタラクティブにデモンストレーションするよう Gemini に指示するプロンプト。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209230976_s1ev99_jNGZl2r_QttuS_eV.jpg" width="600" alt="Tesla FSD の道路認識を示すインタラクティブ SVG デモ - Image 1">
</div>
...
### No. 35: GitHub の React プロジェクトページ UI を再構築する
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209164010_kfcr6v_UVP2rlimdiU6iAGm.jpg" width="600" alt="GitHub の React プロジェクトページ UI を再構築する - Image 1">
</div>
...
### No. 36: Three.js ミュージアム ウォークスルー シーン

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

#### 📖 説明

白い壁と床、ガラスの天井、ホールにブロックがある、小さな一人称視点のウェブゲーム環境のような、歩ける 3D 美術館シーンを three.js で作成するよう Gemini に指示する英語のプロンプト。
...
### No. 38: ミックスとソルブのコントロールを備えた 3D ルービックキューブ Web アプリ
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209166801_28oo2s_Yw11-5ANo4d3iKMe.jpg" width="600" alt="ミックスとソルブのコントロールを備えた 3D ルービックキューブ Web アプリ - Image 1">
</div>
...
### No. 39: Gemini の CapCut のような動画エディター UI
...
Gemini を使用して CapCut スタイルの動画編集アプリケーション インターフェースをデザインするための、非常にシンプルな高レベル プロンプト。
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209229502_z8h43e_Sfw2XxjctaA-jcVN.jpg" width="600" alt="単一ファイル HTML ビリヤード ゲーム - Image 1">
</div>
...
### No. 41: Quantum core monitoring 単一ページ HTML
...
Gemini に「量子コア監視システム」の UI を表す単一ページの HTML (SVG を使用) を生成するよう依頼する簡潔なプロンプト。

#### 📝 プロンプト

```
「{argument name="system_name_en" default="Quantum Core Monitoring System"}」用のシングルページ HTML (SVG) を生成してください。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209232746_9r9qr8_6ATKtxR2C-Z_bgH4.jpg" width="600" alt="Quantum core monitoring 単一ページ HTML - Image 1">
</div>
...
**[👉 今すぐ試す →](https://youmind.com/gemini-3-prompts?prompt=%E3%80%8C%7Bargument%20name%3D%22system_name_en%22%20default%3D%22Quantum%20Core%20Monitoring%20System%22%7D%E3%80%8D%E7%94%A8%E3%81%AE%E3%82%B7%E3%83%B3%E3%82%B0%E3%83%AB%E3%83%9A%E3%83%BC%E3%82%B8%20HTML%20(SVG)%20%E3%82%92%E7%94%9F%E6%88%90%E3%81%97%E3%81%A6%E3%81%8F%E3%81%A0%E3%81%95%E3%81%84%E3%80%82)**

---

### No. 42: 動的点群特殊相対性理論ウェブページ

![Language-ZH](https://img.shields.io/badge/Language-ZH-blue)

#### 📖 説明

特殊相対性理論を説明するためにクールな点群エフェクトを使用する、インタラクティブな物理デモに最適な動的ウェブページを作成するよう Gemini に指示する簡潔な中国語のプロンプト。
...
### No. 44: Neobrutalist ウェブページ生成プロンプト
...
dorksense というタイトルの、非常にクリエイティブでネオブルータリズムな、スムーズスクロールアニメーション、派手な色、Tailwind CSS を備えたレスポンシブなウェブページを生成するためのプロンプト。

#### 📝 プロンプト

```
ネオブルータリズムのウェブページを、極めてクリエイティブに、限界まで挑戦して作成してください。スムーズスクロールアニメーション、派手な色、そして Tailwind CSS スタイルを追加してください。完全にレスポンシブにしてください。ページのタイトルは {argument name="page_title" default="dorksense"} です。
```
...
<div align="center">
<img src="https://cdn.gooo.ai/cms/1764209270654_9o0of1_5Grq3MMeGuW79EHM.jpg" width="600" alt="Neobrutalist ウェブページ生成プロンプト - Image 1">
</div>
...
<sub>🤖 この README は自動生成されています。最終更新： 2025-11-27T12:21:14.172Z</sub>
